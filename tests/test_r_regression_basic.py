...
# Ported: R's var.prob argument maps to the fit-time var_prob kwarg (sklearn
# idiom, like sample_weight). R's spelling as a constructor kwarg
# (RLT_reg(var_prob=...)) correctly raises TypeError — dialect difference.
def test_var_prob_is_accepted_without_error():
    ...
    with pytest.raises(TypeError):
        RLT_reg(n_estimators=30, var_prob=vp)
